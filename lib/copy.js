...
export const copy = {
  metadata: {
    title: "1000 veselīgas receptes — Bez cukura un bez glutēna",
    description:
  ...
  hero: {
    ...
    trustChips: [
      ...
      { icon: "🛡️", text: "Vairāk nekā 75% atlaide šodien" },
    ],
  },

  story: {
    headlinePre: "Cukurs ir klusais ienaidnieks,",
    headlineHighlight: "kas grauj jūsu veselību",
    intro:
  ...
  bonuses: {
    ...
    items: [
      ...
      { image: "/bonuses/bono-8.webp", tag: "DĀVANA 8", title: "500 gardas receptes diabētiķiem", value: "9,41 €" },
    ],
  ...
  finalCta: {
    ...
    subUrgency:
      "Nepalaidiet garām iespēju iegūt recepšu grāmatu ar vairāk nekā 75% atlaidi. Pārveidojiet savu veselību jau tagad ar mūsu pilno ēdienkarti 365 dienām.",
    headline: "365 DIENAS AR RECEPTĒM BEZ CUKURA UN GLUTĒNA + PAPILDU BONUSI",
    bundleList: [
      "1000 receptes bez cukura un bez glutēna",
      "Bonuss 1: Bezcukura desertu receptes",
      "Bonuss 2: Mērču un dip uzkodu receptes",
      "Bonuss 3: Zupu un krēmzupu receptes",
      "Bonuss 4: Receptes ar bezglutēna miltiem",
      "Bonuss 5: Bezglutēna maizes receptes",
      "Bonuss 6: Veselīgu tortilju receptes",
      "Bonuss 7: Veselīgas picas",
      "Bonuss 8: 500 gardas receptes diabētiķiem",
    ],
    guaranteeText:
    ...
    discountBadge: "VAIRĀK NEKĀ 75% ATLAIDE",
  ...
  faq: {
    ...
    doesntWorkHeadline: "KAS NESTRĀDĀ: ❌",
    doesntWork: [
      "❌ ĒST MAZ UN BADOTIES",
    ...
    items: [
      { q: "KĀ ES SAŅEMŠU RECEPTES?", a: "Visu saturu saņemsiet savā e-pastā uzreiz pēc apmaksas veikšanas." },
      { q: "VAI VARU PIEKĻŪT NO TELEFONA?", a: "Jā, recepšu grāmatai varat piekļūt no telefona, planšetdatora vai datora." },
      { q: "VAI VARĒŠU UZDOT JAUTĀJUMUS?", a: "Jā, procesa laikā varat man uzdot visus savus jautājumus tieši e-pastā." },
  ...
  footer: {
    brand: "Crearis",
    copyright: "2026 © Visas tiesības aizsargātas. Iepazīstieties ar mūsu Privātuma politiku.",
  },
};